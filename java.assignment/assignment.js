...
// Quetion: 4
//  var fullName = "sahad ullah"
//  alert( fullName)
// var age = 20 + " years old"
// alert(age)
// var profession = "Web & app development"
// alert(profession )
...
// quetion 2
// var visit = "You have visited this sites 15 times"
// alert(visit)
...
// var product = "watch"
// var quantity = 4
// console.log(name + " order " + quantity + " of " + product)
...
//  quetion 3
// console.log( "<h1>Rules for naming JS variables</h1>" + "\n " + "names only contain num , letter, $" + "for example_variables" + "Variable names can onlycontain letters, numbers, $ , for example $name,name"
...
//  var num2 = 3
// var num = num1 + num2
// console.log("sum of " + num1 + " and " + num2 +" is " + num)
...
// var ticketPrice = 600
// var cost = 5
// console.log( "Total cost to buy " + cost + " tickets to a movie is " + ticketPrice)
...
// console.log("Price of item 1 is " + item1Price)
// console.log("Quantity of item 1 is " + item1Quantity)
// console.log("Price of item 2 is " + item2Price)
...
// quetion 5 "not understand this one"
// var num =prompt("Enter a number")
//  num=5
// if(num){
//      console.loge( "The multiplication table of " + num + ":")
// }else {
//       console.loge( "The multiplication table of " + num + ":")
// }
//  for (let i = 1; i <= 10; i++) {
...
// console.log("wellcome to the city of light " + city)
...
// quetion 3
// var traffic = prompt("traffi signal is", "RED", "yello", "green"// )
// if (traffic === "RED"){
//       console.log("you have to stop")
// }
// var traffic = prompt("traffi signal is", "yellow")
//  if (traffic === "yellow"){
//       console.log("Be ready")
// }
// var traffic = prompt("traffi signal is", "green")
// if (traffic === "green"){
//       console.log("now you can go")
// } 

// quetion 4
// var fuel = prompt("Enter your remaining fuel in car", "0.25")
// if (fuel < 0.25){
...
// console.log("Score of " + students[1] + " is " + scores[1] + ". Percentage: " + (scores[0] / 500 * 100) + "%")
